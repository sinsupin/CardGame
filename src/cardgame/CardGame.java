...
public class CardGame {
    ...
    public static void main(String[] args) {
        ...
        CardTrick userGuess = new CardTrick(value, CardTrick.SUITS[suit - 1]);
        boolean match = false;
        for (CardTrick card : hand) {
        ...
        /**
         * f it is, invoke the printInfo() method
         */
        if (match) {
            printInfo();
        }
    ...
    /**
     * 6. Edit your code on GitHub by modifying the printInfo() to print out
     * your own information (It will help me get to know you better too!).
     */
